...
public class SubirEjemplos {
    ...
    public static void main (String[] args){
        ...
        Cliente c1 = new Cliente("cliente@gmail.com", "avionetas", "Cliente", "03216469 B" , "5291 7509 2363 5061",  new Ubicacion("10000", "Guadalajara" ));

        Cliente c2 = new Cliente("marta@yahoo.com","avionetas", "Marta", "00000000 r", "1234 5678 9123 4567",    new Ubicacion( "20000","Guadalajara"));
        Cliente c3 = new Cliente("carlos@gmail.com","avionetas", "Carlos", "56456465 R","1564 5678 9456 1235", new Ubicacion("15000","Guadalajara"));
        Cliente c4 = new Cliente("hola@gmail.com","avionetas", "Cliente", "56456465 R","1564 5678 9456 1235", new Ubicacion("30000","Guadalajara"));
        ...
        Producto prod3 = new Producto("iPhone", "Móviles y telefonía","iPhoneX",  "Como nuevo",  ".\\src\\javapop\\ImagenesProductos\\HXjMvktYxC-milk-box-package.png","1000", c2, false);
        ...
        Producto prod5 = new Producto("Samsung S7",  "Móviles y telefonía","sddw","Nuevo",  ".\\JavaPoP\\src\\javapop\\ImagenesProductos\\MT1iwUj17B-pastry-box.png","120",c3,true);
